...
class SlateArticleInformation: 
    ...
    def textCleaning(self, text):
        freeArticleLine = 'Slate is making its coronavirus coverage free for all readers. Subscribe to support our journalism. Start your free trial.'
        nextText = re.sub(r'\s+', ' ', text)
        finalText = nextText.replace(freeArticleLine, '')
        return finalText